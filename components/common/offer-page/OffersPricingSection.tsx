...
const OffersPricingSection = ({
  ...
  const monthBadges = [
    ...
    { label: "3 ay", month: "3" },
    { label: "6 ay", month: "6" },
    { label: "12 ay", month: "12" },
  ];

  const benefits = [
    { label: "Zallara giriş sayı", value: "16" },
    { label: "Fərdi qəza", isChecked: true },
    { label: "İdman mağazaları", value: "10% endirim" },
    { label: "Fərdi qəza", value: "10% endirim" },
    { label: "Kasmetoloji", value: "10% endirim" },
    { label: "Məşq proqramları", isChecked: true },
    { label: "Diet proqramı", isChecked: true },
    { label: "Tur pakete endirim", isChecked: true },
    { label: "Spa və hovuza giriş", isChecked: true },
    { label: "Nutrsioloq qəbulu", value: "ayda 1 dəfə" },
    ...
    <section className="space-y-10 md:space-y-20 text-neutral-50">
      ...
      <div className="mx-auto max-w-md">
        <Button asChild variant="outline" size="default" className=" w-full text-primary-700 hover:text-white">
          <Link href="/fitness-centers">Paketə daxil olan zallar</Link>
        </Button>
      </div>
