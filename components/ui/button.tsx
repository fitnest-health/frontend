...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:bg-gray-700 disabled:text-neutral-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary-600 text-primary-foreground hover:bg-primary-700  border-0 ",
        destructive:
        ...
        outline:
          "border bg-background shadow-xs hover:bg-primary-600 hover:text-primary-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 rounded-[32px] text-white border-primary-700!",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: " hover:text-primary-600 dark:hover:bg-accent/50",
        link: "text-[#FAFAFA] underline-offset-4 hover:text-[#00B4CC]",
      },
      size: {
        default: "py-2.5 px-4  rounded-[32px] has-[>svg]:px-3 cursor-pointer",
        sm: " rounded-[32px] gap-1.5 px-4 py-2 has-[>svg]:px-2.5 cursor-pointer",
        lg: " rounded-[32px] px-6 has-[>svg]:px-4 cursor-pointer",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
