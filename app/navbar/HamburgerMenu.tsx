...
import { NewLinks } from "./Navication";
...
const HamburgerMenu = () => {
    ...
    return (
        <div className="md:hidden relative z-20">
            ...
            {/* ICON */}
            <button onClick={() => setOpen(!open)} className="relative z-20 flex justify-end" aria-label="Toggle menu">
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="fixed top-0 right-0 w-[280px] xs:w-[320px] min-h-screen bg-primary-950 shadow-md z-10"
                    >
                        <div className="h-full p-5 pt-20 flex flex-col text-neutral-50">
