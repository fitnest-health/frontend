...
import NutritionBannerImage from '@/public/images/Nutrition.jpg';
import {
    Card,
    CardContent,
    CardHeader,
    ...
    return (
        <>
            <HeroBanner
                ...
                title="Hədəflərinə uyğun qidalan, sağlamlığını gündəlik vərdişə çevir!"
                buttonHref="#"
