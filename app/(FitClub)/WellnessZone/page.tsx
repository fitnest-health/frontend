...
const boxes = [
  {
    title: "Stressin azalması",
    text: "SPA və yoga seansları ilə gündəlik gərginlikdən azad ol, zehnini sakitləşdir.",
  },
  {
    title: "Enerji balansı",
    text: "SPA və yoga seansları ilə gündəlik gərginlikdən azad ol, zehnini sakitləşdir.",
  },
  {
    title: "Zehni aydınlıq",
    text: "SPA və yoga seansları ilə gündəlik gərginlikdən azad ol, zehnini sakitləşdir.",
  },
  {
    title: "Özünü yaxşı hiss et",
    text: "SPA və yoga seansları ilə gündəlik gərginlikdən azad ol, zehnini sakitləşdir.",
  },
];
          ...
          <div className="absolute bottom-0 w-full h-2/4 bg-softblue-950/70 p-6 rounded-4xl lg:flex lg:items-center lg:justify-between lg:h-1/4 lg:pt-10">
            <div>
              ...
              <p className="mt-4 text-b3 leading-b3 text-neutral-50 md:text-s2 md:leading-s2 md:mb-9">
                Gərginlikdən uzaqlaş,{" "}
                <span className="text-primary-700">FitNest</span>-in SPA və yoga
                proqramları ilə balansını yenidən qur.
              </p>
            </div>
      ...
      <div className="lg:my-20">
        <div className="mt-10 mb-8 ml-4">
          ...
          <p className="mt-2 text-neutral-50 font-medium text-b2 leading-b2 md:text-s2 md:leading-s2">
            Hər seans bədənini yeniləyir, zehnini sakitləşdirir və gündəlik
            balansını qorumağa kömək edir.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 items-stretch mb-14 px-4 xl:px-0">
          <div className="relative w-full mx-auto max-w-[728px] aspect-square lg:max-w-[632px] overflow-hidden rounded-4xl h-[300px]  md:h-screen ">
            <Image
              src="/images/wellness.png"
              alt="image"
              fill
              className="object-cover bg-black opacity-70"
            />
          </div>
          <div className="grid grid-cols-1 gap-5 mt-6 lg:mt-0 max-w-[624px] w-full h-screen mx-auto lg:max-w-none lg:mx-0">
            {boxes.map((box, index) => (
              <Card key={index} className="min-h-[120px]">
                <div className="absolute top-5 left-5">
                  <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-full gradient-border  text-white text-s2 leading-s2 sm:text-t2 sm:leading-b1 font-normal">
                    {index + 1}
                  </div>
                  <CardTitle className="mt-6 md:mt-8  text-white text-b1 leading-b1 sm:text-s1 sm:leading-s1 font-semibold">
                    {box.title}
                  </CardTitle>
                  <p className="text-b2 leading-b3 sm:text-b1 sm:leading-b1 text-gray-400">
                    {box.text}
                  </p>
                </div>
              </Card>
